...
const cardPositive = {
  boxShadow: "0 5px 10px rgba(106, 204, 66, 0.65)",
  marginBottom: "10px",
  borderRadius: "20px",
  background: "#76b852" /* fallback for old browsers */,
  background:
    "-webkit-linear-gradient(to right, #8DC26F, #76b852)" /* Chrome 10-25, Safari 5.1-6 */,
  background:
    "linear-gradient(to right, #8DC26F, #76b852)" /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */,
...
const cardNegative = {
  ...
  background:
    "-webkit-linear-gradient(to right, #e73827, #f85032)" /* Chrome 10-25, Safari 5.1-6 */,
  background:
    "linear-gradient(to right, #e73827, #f85032)" /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */,
...
class StockCard extends Component {
  ...
  render() {
    ...
    let iconColor = "rgb(251, 251, 251)";
    if (props) {
      if (props.change < 0) {
        icon = "arrow-down";
        iconColor = "rgb(251, 251, 251)";
          ...
          <Col span={16}>
            ...
            >
              ...
              <Text style={{ fontSize: 10 }}>
                ( {(props.changePercent * 100).toFixed(2)} % )
              </Text>
